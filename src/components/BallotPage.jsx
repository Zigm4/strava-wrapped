...
import { ArrowLeft, Dices, ImageDown, Share2, Copy } from 'lucide-react'
...
// Marathon Majors (aucune donnée Strava nécessaire), choix d'un thème, export de la carte.
export default function BallotPage({ onBack }) {
  ...
  // la saisie survit au rechargement (localStorage), comme le cache d'activités
  useEffect(() => {
      ...
      <div className="controls-col">
        <div className="panel">
          ...
          <div className="ballot-intro">
            ...
            <p>
              ...
              puis partage la carte. Boston n'y est pas : là-bas on souffre à la qualif, pas au tirage.
            </p>
          </div>
        </div>
                ...
                <div className="ballot-race" key={race.id}>
                  ...
                  <div className="br-counters">
                    ...
                    <div className="counter yes">
                      <span className="c-lbl">✅ Accepté</span>
                      <div className="c-ctrl">
        ...
        <div className="panel">
          ...
          <button className="btn btn-ghost" style={{ width: '100%' }} onClick={() => setSeed((s) => s + 1)}>
            <Dices size={16} /> Re-mélanger les punchlines
          </button>
          <div className="helper" style={{ marginTop: 10 }}>
            Les textes de la carte sont en anglais (c'est elle qui se partage) et tirés au sort —
            re-mélange jusqu'à trouver ta préférée.
          </div>
          <div className="export-row">
            ...
            {canCopy && (
              <button className="btn btn-ghost" onClick={exp.handleCopy} disabled={exp.exporting}>
                <Copy size={16} /> Copier
              </button>
            )}
          </div>
